...
export const moreDestinations = [
  {
    ...
    feeling: 'Green · Grounded · Restorative',
    image: images.hammam,
    desc: 'Just beyond Cairo, working farms, gardens and agricultural estates offer a grounded, nourishing setting — close to the city yet a world away.',
    experiences: ['Farm-to-table dining', 'Garden yoga', 'Nutrition workshops', 'Nature walks', 'Digital detox', 'Slow living rituals', 'Herbal & wellness sessions'],
